...
export const Panel = ({ className, children, variant = "default" }: PanelProps) => {
  ...
  return (
    <div className={cn(panelClass, "motion-panel relative p-1 group", className)}>
      ...
      <div className="absolute top-1 right-1 w-2 h-2 border-t border-r border-primary/40 group-hover:border-primary transition-colors duration-300" />
      <div className="absolute bottom-1 left-1 w-2 h-2 border-b border-l border-primary/40 group-hover:border-primary transition-colors duration-300" />
